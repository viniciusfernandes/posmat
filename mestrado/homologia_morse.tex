...
\begin{document}
	...
	\begin{teorema}
		(Decomposição polar) Sejam $(V, \innerprod{}{})$ um n-espaço vetorial real com um produto interno positivo definido e $A \in GL(V, \real{})$, então podemos escrever $A=PO$ onde $P,O\in  \mathcal{L}(V)$ tal que $P = P^{t}$ (auto-adjunta) e $OO^{t} = Id$ (ortogonal).
	\end{teorema}
	\begin{prova}
