...
\begin{document}
	...
	\begin{prova}
		...
		\right),
		$$
		mas dado $Z = B+iC$ temos pela caracterização anterior que $A = F(Z)$ logo $A\in \matrizunitaria{n}$, portanto $\mathcal{U} \subseteq F(\matrizunitaria{n})$. Conclusão $\mathcal{U} = \matrizunitaria{n}$. Já demonstramos que $F$ é monomorfismo, então $F|_{\matrizunitaria{n}}:\matrizunitaria{n} \to \mathcal{U}$ é sobrejetora sobre sua imagem, portanto é um isomorfismo.
	\end{prova}
	...
	\end{teorema}
	\begin{prova}
		Afirmo que $\mathcal{U} \subset \matrizunitaria{n}$ é um subgrupo normal. De fato, tomando $A \in \mathcal{U}$ temos que $A^{t}A=A1A$
	\end{prova}
