...
\alerta{	\begin{observacao} (Não sei onde colocar essa observação...!!!!)
	...
	Considere a aplicação $\pi_{2} \circ i \circ \operadorFloer: \caminhosexponenciaisconectantespadrao\to \espacoLpcontradominio{\retacartesianocirculo}{\real{m}}$ definida por 
	$$
	(\pi_{2} \circ i \circ \operadorFloer)(u)=\operadorFloerDefinicao{u},
	$$
	onde $i$ é a a composição do mergulho $TM\hookrightarrow \real{m}\times \real{m}$ com a projeção $\pi_{2}$ anteriomente definida. Por um abuso de notação será denotado $\pi_{2} \circ i \circ \operadorFloer$ por $\operadorFloer$.
