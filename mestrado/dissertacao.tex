...
\newcommand{\produtotensorialreal}[2]{ #1_{1} \otimes_{\reta} \dots \otimes_{\reta} #1_{#2}}
...
\begin{document}
	...
	\end{corolario}
	\begin{prova}
		A demonstração não esta completa e será finalizada futaramente.
	\end{prova}
	...
	Sabemos que $\gruposimpletico{2n}$ é conexo por caminhos, logo a definição de um índice de Maslov que não se restrinja a caminhos fechados enriquece mais a teoria do que nos atermos apenas a caminhos fechados.
