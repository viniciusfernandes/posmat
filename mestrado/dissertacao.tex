...
\begin{document}
	...
	Futuramente mostratemos que a aplicação $\rho$ pode ser estendida continuamente para $\gruposimpletico{2n}$ e com isso provaremos que $\rho$ satisfaz todas as condições do Teorema $\ref{teorema_aplicacao_rho}$.
