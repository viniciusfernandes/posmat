...
\begin{document}
	...
	\begin{proposicao}\label{proposicao_diferencial_floer_adjunto}
		Em termos de distribuição, o operador $\diferencialfloeradjponto{u}:\espacoLpcontradominio{\retacartesianocirculo}{\real{2n}} \to \espacosobolevcontradominio{\retacartesianocirculo}{\real{2n}}$ é dado por
		$$
