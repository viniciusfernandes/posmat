...
\begin{document}
	...
	\begin{observacao}
		O índice de Maslov de um caminho $\psi \in \caminhossempontobase{\circulo}$ esta relacionado com a aplicação grau, definida no Capítulo \ref{capitulo_grupo_fundamental}, do seguinte modo: $\mu(\psi) = 2deg(\rho\circ \psi)$.
	\end{observacao}
