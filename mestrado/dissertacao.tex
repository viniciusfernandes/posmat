...
\begin{document}
	...
	As demonstrações do teorema que segue e seu corolário, podem ser encontradas em \cite{breazis_sobolev_spaces}.
	...
	\begin{teorema}
		(Propriedade de Fredholm de $\diferencialfloer$) Suponha que $det(Id - \Psi^{\pm}(1)) \neq 0$. Então o operador $\diferencialfloer: \espacosobolevcontradominio{\retacartesianocirculo}{\real{2n}} \to \espacoLpcontradominio{\retacartesianocirculo}{\real{2n}}$ é um operador de Fredholm para $1<p<\infty$.
	\end{teorema}
	\begin{prova}
