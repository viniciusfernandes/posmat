...
\begin{document}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[height=5cm]{imagem/colagem_celula.pdf}
	...
	\begin{exemplo}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=9cm]{imagem/disco_alca.pdf}
	...
	\begin{observacao}
		Como todo $2n$-espaço vetorial simplético é simplectomorfo a $(\real{2n}, \omega_{0})$, então é suficiente estudar o $\gruposimpletico{\real{2n}}$. Quando não houver ambiguidades, esse conjunto será denotado por $\gruposimpletico{\real{2n}}$.
	\end{observacao}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[height=7cm]{imagem/extensao_solucao.pdf}
	...
	\begin{definicao}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=5cm]{imagem/caminhos_especiais_em_Sp2n.pdf}
	...
	\begin{prova}
		...
		\begin{enumerate}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[height=6cm]{imagem/caminho_naturalidade.pdf}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[height=7cm]{imagem/prolongamento_homotopico.pdf}
			...
			\begin{figure}[!h]
				\centering
				\includegraphics[height=5.2cm]{imagem/prolongamento_homotopico_2.pdf}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[height=5.5cm]{imagem/colagem_disco_cilindro.pdf}
