...
\begin{document}
	...
	\begin{prova}
		\begin{enumerate}
			...
			$$
			Por outro lado, vamos supor que $n = deg(\gamma)=deg(\beta)$. Considere os levantamentos $\alpha$ e $\lambda$, dos caminhos $\gamma$ e $\beta$, respectivamente. Seja $H:[0,1]\times [0,1] \to \real{}$ definida por $H(t,s) = (1-s)\alpha(t) + s\beta(t)$. Então $H(t,0)=\alpha(t)$ e $H(t,1)=\lambda(t)$, logo $H$ é uma homotopia livre entre $\alpha$ e $\lambda$. Além disso 
			$$
			\begin{aligned}
			H(1,s) - H(0,s) 
