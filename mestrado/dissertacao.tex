...
\alerta{	\begin{observacao} (Não sei onde colocar essa observação...!!!!)
	...
	Logo, o operador de Floer $\operadorFloer$ pode ser tratado como uma aplicação $\operadorFloer: \caminhosexponenciaisconectantespadrao\to \espacoLpcontradominio{\retacartesianocirculo}{\real{m}}$. Para calcular o diferencial de $\operadorFloer$ em $u \in \caminhosexponenciaisconectantespadrao$, tome uma  deve-se calcular o limite
	$$
	\lim\limits_{\tau\to 0}\frac{\operadorFloerParametro{\exp(w, \tau Y)}-\operadorFloerParametro{u}}{\normaLp{\tau Y}}.
	$$
