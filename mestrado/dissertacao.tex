...
\begin{document}
	...
	\begin{itemize}
		...
		\item[] \textbf{Capítulo 2:} a primeira seção expõe rapidamente os principais conceitos da Teoria de Morse Clássica, tais como as propriedades de uma função de Morse, os teorema de deformação de associam um CW-complexo a uma função de Morse e as Desigualdades de Morse. A segunda seção é reservada para a Teoria de Morse-Smale-Witten e para a definição do complexo de Morse-Smale-Witten e sua homologia. Exemplos e figuras complementam o capítulo.
