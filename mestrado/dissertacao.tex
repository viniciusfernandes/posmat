...
\begin{document}
	...
	\section{Espaço de Sobolev $W^{1,p}$}
	\begin{definicao}
	...
	De acordo com a proposição a seguir, demonstrada em $\cite{breazis_sobolev_spaces}$, os espaços de Sobolev $W^{1,p}$ munidos da norma $\normaWp{f} = \normaLp{f}+\sum_{j}\normaLp{\partial_{j} f}$, formam uma espaço de Banach.
