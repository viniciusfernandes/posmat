...
\begin{document}
	...
	\begin{itemize}
		\item[] \textbf{Capítulo 1:} expõe o conteúdo prelimiar sobre topologia algébrica necessário para o entendimento dos capítulos posteriores, e está segmentado em duas seções: a primeira seção é dedicada à definição do grupo fundamental, da aplicação grau e demonstração de algumas de suas propriedades. São feitos alguns exemplos de cálculo dos grupos fundamentais para alguns espaços topológicos utilizando a aplicação grau. A segunda seção é dedicada a álgebra homológica. Mais espeficicamente, à Homologia Singular e Homologia Celular. Exemplos e figuras ilustrando a estrutura celular de espaços topológicos dão ênfase a Homologia celular.
		
		\item[] \textbf{Capítulo 2:} a primeira seção expõe rapidamente os principais conceitos da Teoria de Morse Clássica, tais como as propriedades de uma função de Morse, os teorema de deformação de associam um CW-complexo a uma função de Morse e as Desigualdades de Morse. A segunda seção é reservada para a Teoria de Morse-Smale-Witten e para a definição do complexo de Morse-Smale-Witten e sua homologia. Exemplos e figuras completam o capítulo.
		
		\item[] \textbf{Capítulo 3:} aqui são expostos os principais conceitos sobre espaços vetoriais simpleticos e simplectomorfismos, bem como suas propriedades, tais como: a caracterização da forma simlética e de subespaços simpléticos, lagrangianos e isotrópicos. Por fim, é demonstrado o teorema de existência de uma base simplética.
		
		\item[] \textbf{Capítulo 4:} é definido o grupo das transformações simpleticas, chamado grupo simplético. São demonstradas uma de suas caracterizações e um homeomorfismo entre as transformações simpléticas ortogonais e as matrizes unitárias. Também é realizado uma investigação dos auto-valores das transformações simléticas via complexificação dos espaços vetoriais simpléticos, visando estudar alguns aspectos topológicos do grupo simplético. Por fim, um cálculo do grupo fundamental do grupo simpletico é realizado.
		
		\item[] \textbf{Capítulo 5:} esse é o ponto central do trabalho. Nele é definido o Índice de Maslov e, utilizando os resultados obtidos nos capítulos anteriores, tais como, as propriedades das transformações simpléticas e a topologia do grupo simplético, propriedades da aplicação grau e a definição do grupo fundamental, as propriedades desse índice são demonstradas em detalhes. Algumas figuras ilustram as definições desse capítulo.
		
		\item[] \textbf{Capítulo 6:} esse é o capítulo mais extenso do trabalho por conta do volume de álgebra e análise nas demonstrações dos resutlados. Na primeira parte são apresentados a definição e propriedades das variedades simpléticas, os sistemas Hamiltonianos e algumas características do conjunto de suas soluções. Na segunda parte é definido o funcional de ação, a caracterização de seus pontos críticos e é determinada a expressão de seu campo gradiente, e posteriormente, é demonstrado que as linhas de fluxo gradiente desse funcional são as soluções de energia finita da Equação de Floer. Na terceira e ultima parte, é definido o Índice de Conley-Zehnder de uma solução periódica do sistema Hamiltonia.
