...
\begin{document}
	...
	\correcaobanca{Votlado apenas para cap. 5 e 7 que não é o centro do trabalho.}
	...
	\begin{exemplo}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=4cm]{imagem/cw_esfera.pdf}
	...
	\begin{exemplo}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=3cm]{imagem/disco_alca.pdf}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[height=7cm]{imagem/cw_2_toro_refeito.pdf}
