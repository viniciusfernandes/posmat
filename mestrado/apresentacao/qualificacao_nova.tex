...
\begin{document}
	...
	\begin{frame}
		...
		\begin{definicao}
			$J: V \to V$ é um endomorfismo tal que $J^{2} = -Id$. 
			\\~\\
			
			$J$ é $\omega$-compatível se $g(u,v):=\omega(u, Jv)$ é um produto interno. 
			\\~\\
			
			$\estruturascomplexaspadrao$ o conjunto de todas as estruturas complexas $\omega$-compatíveis.
			\\~\\
