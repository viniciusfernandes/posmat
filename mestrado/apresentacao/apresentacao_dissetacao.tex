...
\begin{footnotesize}
	...
	\begin{frame}
		...
		Sejam os conjuntos $\gruposimpleticonaodegenerado{\pm} = \{ A \in \gruposimpletico{2n}: \pm det(Id-A)> 0 \}$ e 
		$$
		\gruposimpleticonaodegenerado{*} = \{ A \in \gruposimpletico{2n}: det(Id-A)\neq 0 \}.
		$$
