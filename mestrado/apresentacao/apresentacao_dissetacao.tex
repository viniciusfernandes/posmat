...
\begin{footnotesize}
	...
	\begin{frame}
		...
		\begin{minipage}[t]{0.3\linewidth}
			\begin{figure}
				\centering
				\textbf{}\par
				\includegraphics[height=2.5cm]{../imagem/conjunto_nivel_zoom_2}
			\end{figure}
	...
	\begin{frame}
		...
		\begin{figure}[!h]
			\centering
			\includegraphics[height=1.5cm]{../imagem/linha_fluxo_gradiente_repelindo.pdf}
		\end{figure}
	...
	\end{frame}
		...
		\begin{frame}
			...
			\begin{minipage}[t]{0.5\linewidth}
				\begin{figure}[!h]
					\centering
					\includegraphics[height=2.3cm]{../imagem/caminhos_especiais_em_Sp2n.pdf}
				\end{figure}
			\end{minipage}
			\hfill%
			\begin{minipage}[t]{0.3\linewidth}
		...
		\begin{prova}
			\begin{itemize}
				...
				\begin{itemize}
					...
					\begin{scriptsize}
						\item $W^{+}=diag\{-1,-1,\dots,-1, -1,-1,\dots,-1\} $ 
						
						\item $W^{-}=diag\{2,-1,\dots,-1, 1/2,-1,\dots,-1\}$.
						
						\item $\rho_{\Psi}(0) = 1$ e $\rho_{\Psi}(1) = \rho(W^{\pm})  \in \{ -1,1\}$
				...
				\begin{itemize}
					\begin{scriptsize}
						...
						\item $(\Leftarrow) \;\;\mu(\psi_{1}) = \mu(\psi_{2}) \Rightarrow \deg(\rho_{\Psi_{1}}) = \deg(\rho_{\Psi_{2}}) \Rightarrow \Psi_{1}\sim \Psi_{2}$ e $\psi_{1}\sim \psi_{2}$.
