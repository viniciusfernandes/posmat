...
\begin{document}
	...
	\begin{enumerate}
		\item Sejam $U_{1}, U_{2} \subset M$ e $U = U_{1} \cup U_{2}$ subconjuntos abertos de uma n-variedade diferenciável, e se $D_{U_{1}\cap U_{2}}: \cohomologia{p}{U_{1}\cap U_{2}} \to \cohomologiacompac{n-p}{U_{1}\cap U_{2}}$ for um isomorfismo, então $D_{U}: \cohomologia{p}{U} \to \cohomologiacompac{n-p}{U}$ é um isomorfismo.
		
		\item Seja $\{U_{\alpha} \subset M^{n}: \alpha \in J \}$ uma família de subconjuntos de uma n-variedade diferenciável e $U = \bigcup_{\alpha \in J} U_{\alpha}$. Se $D_{U_{\alpha}}: \cohomologia{p}{U_{\alpha}} \to \cohomologiacompac{n-p}{U_{\alpha}}$, então $D_{U}: \cohomologia{p}{U} \to \cohomologiacompac{n-p}{U}$  é um isomorfismo.
		
		\item Seja $U \subseteq M^{n}$ um subconjunto de uma n-variedade diferenciável difeomorfo a $\real{n}$, então $D_{U}: \cohomologia{p}{U} \to \cohomologiacompac{n-p}{U}$  é um isomorfismo.
	\end{enumerate}
