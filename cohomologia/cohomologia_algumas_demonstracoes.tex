...
\begin{document}
	...
	\vspace{2mm}
	\textit{\textbf{Teorema (existência da Dualidade de Poincaré):} Seja $M^{n}$ uma n-variedade diferenciável e orientável, então existe $U \subseteq M$ tal que $D_{U} : \cohomologia{p}{U} \to \cohomologiacompacdual{n-p}{U}$ onde $0 \leq p \leq n$.}
