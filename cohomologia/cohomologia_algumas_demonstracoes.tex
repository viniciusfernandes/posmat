...
\begin{document}
	...
	$\square$ Como $g^{p}$ é sobrejetora, então existe $b \in B^{p}$ tal que $g^{p}(b) = c$ e $d^{p}g^{p}(b) = d^{p}c$. Como $f^{p}$ é injetora, então existe um único $a \in A^{p}$ tal que $f^{p}(a) = d^{p}g^{p}(b)$
