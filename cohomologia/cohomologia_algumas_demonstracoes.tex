...
\begin{document}
	...
	\tableofcontents
	\vspace{8mm}
	\textit{\textbf{Observação:} Essas notas tiveram como base o livro - From Calculus to Cohomology, Lars Bojer Madsen and Jorgen Tornehave.}
	...
	\section{Sequência de Mayer-Vietoris}
	...
	\section{Exemplos de cohomologias}
	...
	\chapter{Isomorfismo entre $\cohomologiacompac{n}{M}$ e $\real{}$}
	...
	\section{Integração de formas diferenciáveis}
	...
	\section{$\cohomologiacompac{n}{M}$ e $\real{}$ são isomorfos}
	...
	\chapter{Grau de Aplicação}
	
	\section{O grau de uma aplicação é um inteiro}
	...
	\section{Teorema de índices para campos}
	\vspace{2mm}
	...
	\chapter{Característica de Euler e o Teorema de Hopf-Poincaré}
	
	\section{Propriedades da característica de Euler}
	...
	\section{Teorema de Gauss-Bonnet em $\real{3}$}
