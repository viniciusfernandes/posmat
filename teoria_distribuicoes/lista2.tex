...
\begin{document}
	...
	\begin{enumerate}
		...
		$$
		\mathcal{F}(k) = \frac{1}{2\pi}\int_{\pi}^{-\pi} f(x)e^{-ikx}dx
		$$
		...
		\begin{enumerate}
			...
			\item Mostre que
			$$
			||\mathcal{F}|| \leq \frac{1}{2\pi}||f||_{L^{1}}\leq ||f||_{L^{\infty}},
			$$
			e conclua que a sequência $\mathcal{F} := (f(k))_{k \in \mathbb{Z}}$ é um elemento de $\ell^{\infty}(\mathbb{Z})$.
			
			\textbf{Solução:} Vamos definir $||\mathcal{F}||:= \sup_{k \in \mathbb{Z}}|\mathcal{F}(k)|$, então:
			
			$$
			|\mathcal{F}(k)| = \frac{1}{2\pi} \Big |\int_{\pi}^{-\pi} f(x)e^{-ikx}dx \Big | \leq \frac{1}{2\pi} \int_{\pi}^{-\pi} |f(x)|dx = \frac{1}{2\pi}||f||_{L^{1}} \Rightarrow  
			$$
			$$
			\Rightarrow ||\mathcal{F}||:= \sup_{k \in \mathbb{Z}}|\mathcal{F}(k)| \leq \frac{1}{2\pi}||f||_{L^{1}}.
			$$
