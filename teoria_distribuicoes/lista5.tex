...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\begin{aligned}
			\int_{\Omega}|f(x)|^{p}
			= & \int_{\Omega_{1}}|f(x)|^{p} + \int_{\Omega_{2}}|f(x)|^{p} \\
			\leq & \int_{\Omega_{1}} 1 + \int_{\Omega_{2}}|f(x)|^{p} \\
			= & \omega^{p}_{1} + \int_{\Omega_{2}}|f(x)|^{p} \\
			\leq & \omega^{p}_{1} + \int_{\Omega_{2}}|f(x)|^{q} = \underbrace{ \omega^{p}_{1} }_{< \infty }+ \underbrace{ ||f||_{q}^{q} }_{< \infty} < \infty \\
