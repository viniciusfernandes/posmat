...
\begin{document}
	...
	\begin{enumerate}
		...
		Vamos agora mostrar que $u \in \mathcal{S}'(\mathbb{R})$ tal que $u(x) = c_{1} + c_{2}\theta(x) + \ln|x|$ é uma solução fraca para $xu'(x) = 1$. Com efeito, tomando $\phi \in \mathcal{S}(\mathbb{R})$ então:
		$$
		\begin{aligned}
		...
		\end{aligned}
		$$
		logo, $xu'(x) = 1$ (no sentido distibucional), como desejávamos.
