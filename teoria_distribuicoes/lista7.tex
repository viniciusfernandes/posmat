	...
	\begin{enumerate}
		...
		\item \textbf{Solução:} Por simplicidade, vamos definir a notação $C^{0} = C^{0}(\mathbb{R}^{n})$, e tomaremos $f, g \in C^{0}$ e $\lambda \in \mathbb{R}$.
			\begin{enumerate}
				...
				\\
				= & \int_{\mathbb{R}} f(y)\varphi(\underbrace{ A^{-1}(y - b)}_{T^{-1}y} ) \underbrace{ \Big| J_{T}(x) \Big|}_{Det. Jacob.}
				\\
				= & \int_{\mathbb{R}} f(y)\varphi(T^{-1}y) \Big| \frac{\partial T_{i}}{\partial x_{j}}(x) \Big|
				\\
