	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\item Sabemos que o produto de uma função diferenciável por uma constante resulta em uma função diferenciável, isto é, $\forall g \in C^{\infty}$ temos que $\lambda g \in C^{\infty}_{0}$, além disso, temos que $supp(\lambda g) = \overline{\{x \in \Omega: \lambda g(x) \neq 0\}} = \overline{\{x \in \Omega: g(x) \neq 0\}} = supp(g)$, portanto $\lambda g \in C^{\infty}_{0}$
